...
let str_dbl = "es un texto con comillas dobles"
let str_sng = 'es un texto con comillas simples'
...
let str_backticks = `Este es un texto con backticks`
...
let libros = ["suvinc as", "dkzjvbkjsnf", "ksgcbkw"]
